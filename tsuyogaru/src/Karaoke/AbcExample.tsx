...
//%%endsvg` +
    ...
    "z =EF F=E c2|F2 z2 z4|" + // Tsuyogaru Ga-ru!
    ...
    "z2 (c2 F2) G2|c3 A A4|d3 c c4|e4 G4|A4 " + // kitto itsuka wa itsuka wa happīend
    "AG F2|F2 D2 F2 A2|B2 A2 (G2 F2)|F8-|F8|" + // hashire! Yuiitsu muni no unmei
    "AAAF B2 AA|G2 A2 z4|" + // tsuyo garu gāru wa saikyō!
    "zA GF zF GD-|D" + // (Fuzake) sawagi kagayaite ku
    ...
    "z8|c3 A A4|d3 c c4|e4 G4|A4 " + // (kitto) itsuka wa itsuka wa happīend
    ...
    "pī-su shi-te! " +
    "nan-do mo nan-do mo ma-ke-te ya-re! " +
    "itsu-ka wa itsu-ka wa hap-pī-end " +
    "tsu-yo-ga-ru gā-ru wa sai-kyō!" +
